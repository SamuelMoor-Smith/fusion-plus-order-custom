...
(async () => {
    ...
    arbitrumFactoryAdress = '0x65b3db8baef0215a1f9b14c506d2a3078b2c84ae';
    monadFactoryAddress = ''

    const provider = new JsonRpcProvider(nodeUrl);
    const tkn = new Contract(arbitrumFactoryAdress, approveABI, new Wallet(makerPrivateKey, provider));
    await tkn.approve(
        '0x111111125421ca6dc452d289314280a0f8842a65', // aggregation router v6
        (2n**256n - 1n) // unlimited allowance
    );
